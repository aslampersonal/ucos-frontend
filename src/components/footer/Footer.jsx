...
function Footer () {
    ...
    return (
        ...
        //             <div id="f-link-first">
        //                 <a className="f-links" href='./index.html'>Home</a>
        //                 <a className="f-links" href='./index.html'>Shop All</a>
        //                 <a className="f-links" href='./index.html'>Cosmetics</a>
        //                 <a className="f-links" href='./index.html'>Women's Skincare</a>
        //                 <a className="f-links" href='./index.html'>Men's Skincare</a>
        //             </div>
        //             <div id="f-link-second">
        //                 <a className="f-links" href='./index.html'>About Us</a>
        //                 <a className="f-links" href='./index.html'>Contact Us</a>
        //                 <a className="f-links" href='./index.html'>Privacy Policy</a>
        //                 <a className="f-links" href='./index.html'>FAQs</a>
        //             </div>
        //         </div>
        //         <div id="footer-social-div">
        //             <a className="f-social-links" href='./index.html'>
        //                 <svg
        ...
        //             <span id="f-copyright-text">
        //                 © 2023 UCOS. Designed &amp; Maintained by MOHAMMED ASLAM
        //             </span>
        //         </div>
        //     </div>
        // </footer>
